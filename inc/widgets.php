...
class Twenty_Fourteen_Ephemera_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			'widget_iw2014_ephemera',
			__( 'Twenty Fourteen Ephemera', 'iw2014' ),
			array(
				'classname'                   => 'widget_iw2014_ephemera',
				'description'                 => __( 'Use this widget to list your recent Aside, Quote, Video, Audio, Image, Gallery, and Link posts.', 'iw2014' ),
	...
	public function widget( $args, $instance ) {
		...
		switch ( $format ) {
			case 'image':
				$format_string      = __( 'Images', 'iw2014' );
				$format_string_more = __( 'More images', 'iw2014' );
				break;
			case 'video':
				$format_string      = __( 'Videos', 'iw2014' );
				$format_string_more = __( 'More videos', 'iw2014' );
				break;
			case 'audio':
				$format_string      = __( 'Audio', 'iw2014' );
				$format_string_more = __( 'More audio', 'iw2014' );
				break;
			case 'quote':
				$format_string      = __( 'Quotes', 'iw2014' );
				$format_string_more = __( 'More quotes', 'iw2014' );
				break;
			case 'link':
				$format_string      = __( 'Links', 'iw2014' );
				$format_string_more = __( 'More links', 'iw2014' );
				break;
			case 'gallery':
				$format_string      = __( 'Galleries', 'iw2014' );
				$format_string_more = __( 'More galleries', 'iw2014' );
				break;
			case 'aside':
			default:
				$format_string      = __( 'Asides', 'iw2014' );
				$format_string_more = __( 'More asides', 'iw2014' );
				break;
		}
		...
		if ( $ephemera->have_posts() ) :
				...
				<div class="entry-content">
					...
					if ( has_post_format( 'gallery' ) ) :
						...
						if ( post_password_required() ) :
							the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'iw2014' ) );
							else :
								$images = array();
						...
						<p class="wp-caption-text">
								...
								printf(
									...
									_n( 'This gallery contains <a href="%1$s" rel="bookmark">%2$s photo</a>.', 'This gallery contains <a href="%1$s" rel="bookmark">%2$s photos</a>.', $total_images, 'iw2014' ),
			...
			<a class="post-format-archive-link" href="<?php echo esc_url( get_post_format_link( $format ) ); ?>">
				<?php
					...
					printf( __( '%s <span class="meta-nav">&rarr;</span>', 'iw2014' ), $format_string_more );
				?>
			</a>
			<?php
	...
	function form( $instance ) {
		...
		?>
			<p><label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php _e( 'Title:', 'iw2014' ); ?></label>
			<input id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" class="widefat" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>"></p>

			<p><label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>"><?php _e( 'Number of posts to show:', 'iw2014' ); ?></label>
			<input id="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'number' ) ); ?>" type="text" value="<?php echo esc_attr( $number ); ?>" size="3"></p>

			<p><label for="<?php echo esc_attr( $this->get_field_id( 'format' ) ); ?>"><?php _e( 'Post format to show:', 'iw2014' ); ?></label>
